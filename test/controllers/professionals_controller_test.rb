...
class ProfessionalsControllerTest < ActionController::TestCase
  ...
  test "should create professional" do
    assert_difference('Professional.count') do
      post :create, professional: { description: @professional.description, email: @professional.email, name: @professional.name, password: @professional.password, phonenumber: @professional.phonenumber }
    end
  ...
  test "should update professional" do
    patch :update, id: @professional, professional: { description: @professional.description, email: @professional.email, name: @professional.name, password: @professional.password, phonenumber: @professional.phonenumber }
    assert_redirected_to professional_path(assigns(:professional))
  end
